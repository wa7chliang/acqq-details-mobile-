	...
	html{
        ...
        .mod-header{
            ...
            .header-cover{
                width: 100%;
                height: 100%;
                background:url("./header.jpg")no-repeat 0 -10rem;
                -webkit-background-size:21rem 28rem;
